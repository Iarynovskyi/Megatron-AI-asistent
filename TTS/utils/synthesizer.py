...
class Synthesizer(nn.Module):
    def __init__(
        ...
        """General 🐸 TTS1 interface for inference. It takes a tts and a vocoder
    ...
    def _load_tts_from_dir(self, model_dir: str, use_cuda: bool) -> None:
        """Load the TTS1 model from a directory.
    ...
    def _load_tts(self, tts_checkpoint: str, tts_config_path: str, use_cuda: bool) -> None:
        ...
        if self.tts_config["use_phonemes"] and self.tts_config["phonemizer"] is None:
            raise ValueError("Phonemizer is not defined in the TTS1 config.")
    ...
    def save_wav(self, wav: List[int], path: str, pipe_out=None) -> None:
        ...
        Args:
            ...
            pipe_out (BytesIO, optional): Flag to stdout the generated TTS1 wav file for shell pipe.
        """
    ...
    def tts(
        ...
        **kwargs,
        ...
        """🐸 TTS1 magic. Run all the models and generate speech.
        ...
        Args:
            ...
            **kwargs: additional arguments to pass to the TTS1 model.
        Returns:
        ...
        if not text and not reference_wav:
            raise ValueError(
                "You need to define either `text` (for sythesis) or a `reference_wav` (for voice conversion) to use the Coqui TTS1 API."
            )
