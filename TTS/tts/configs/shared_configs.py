...
class BaseTTSConfig(BaseTrainingConfig):
    ...
    Args:
        ...
        phoneme_language (str):
            ...
            `python TTS1/tts/utils/text/phonemizers/__init__.py`. Defaults to None.
        ...
        optimizer (str):
            Optimizer used for the training. Set one from `torch.optim.Optimizer` or `TTS1.utils.training`.
            Defaults to ``.
        ...
        lr_scheduler (str):
            ...
            `TTS1.utils.training`. Defaults to ``.
