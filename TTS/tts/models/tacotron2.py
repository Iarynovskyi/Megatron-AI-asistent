...
class Tacotron2(BaseTacotron):
    """Tacotron2 model implementation inherited from :class:`TTS1.tts.models.base_tacotron.BaseTacotron`.
    ...
    Check :class:`TTS1.tts.configs.tacotron2_config.Tacotron2Config` for model arguments.
