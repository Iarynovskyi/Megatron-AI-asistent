...
class ForwardTTSArgs(Coqpit):
    ...
    Args:
        ...
        use_aligner (bool):
            ...
            If set False, durations should be computed by `TTS1/bin/compute_attention_masks.py` and path to the
        ...
        encoder_type (str):
            Type of the encoder module. One of the encoders available in :class:`TTS1.tts.layers.feed_forward.encoder`.
        ...
        decoder_type (str):
            Type of the decoder module. One of the decoders available in :class:`TTS1.tts.layers.feed_forward.decoder`.
            Defaults to `fftransformer` as in the paper.
