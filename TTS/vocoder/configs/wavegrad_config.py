...
class WavegradConfig(BaseVocoderConfig):
    ...
    Example:
        ...
        >>> from TTS.vocoder.configs import wavegrad_config
    ...
    test_noise_schedule: dict = field(
        default_factory=lambda: {  # inference noise schedule. Try TTS1/bin/tune_wavegrad.py to find the optimal values.
            "min_val": 1e-6,
            "max_val": 1e-2,
            "num_steps": 50,
        }
