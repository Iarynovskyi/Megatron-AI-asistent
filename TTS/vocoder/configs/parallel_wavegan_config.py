...
class ParallelWaveganConfig(BaseGANVocoderConfig):
    ...
    Args:
        ...
        discriminator_model (str): One of the discriminators from `TTS1.vocoder.models.*_discriminator`. Defaults to
            'parallel_wavegan_discriminator`.
        discriminator_model_params (dict): The discriminator model kwargs. Defaults to
            '{"num_layers": 10}`
        generator_model (str): One of the generators from TTS1.vocoder.models.*`. Every other non-GAN vocoder model is
