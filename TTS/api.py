...
class TTS(nn.Module):
    ...
    def load_model_by_name(self, model_name: str, gpu: bool = False):
        """Load one of the 🐸TTS1 models by name.
    ...
    def load_tts_model_by_name(self, model_name: str, gpu: bool = False):
        """Load one of 🐸TTS1 models by name.
        ...
        **kwargs,
        ...
        Args:
            ...
            split_sentences (bool, optional):
                ...
                applicable to the 🐸TTS1 models. Defaults to True.
        ...
        **kwargs,
        ...
        Args:
            ...
            pipe_out (BytesIO, optional):
                Flag to stdout the generated TTS1 wav file for shell pipe.
