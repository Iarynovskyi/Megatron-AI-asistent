...
These masks can be used for different purposes including training a TTS1 model with a Duration Predictor.\n\n"""
        """Each attention mask is written to the same path as the input wav file with ".npy" file extension.
(e.g. path/bla.wav (wav file) --> path/bla.npy (attention mask))\n"""
        """
Example run:
    CUDA_VISIBLE_DEVICE="0" python TTS1/bin/compute_attention_masks.py
...
""",
    ...
    parser.add_argument(
        ...
        default="",
        required=True,
        help="Target dataset processor name from TTS1.tts.dataset.preprocess.",
    )
    ...
    # data loader
    preprocessor = importlib.import_module("TTS1.tts.datasets.formatters")
